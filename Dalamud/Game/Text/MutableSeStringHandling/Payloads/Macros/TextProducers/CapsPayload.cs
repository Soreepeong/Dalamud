...
/// <summary>Produces a text in all uppercase.</summary>
public sealed class CapsPayload : FixedFormPayload
{
    /// <summary>Initializes a new instance of the <see cref="CapsPayload"/> class.</summary>
    public CapsPayload()
        : base(1, 1, (int)Lumina.Text.Payloads.MacroCode.Caps)
    {
    }
