...
/// <summary>Produces a text with its first character lowercased.</summary>
public sealed class LowerHeadPayload : FixedFormPayload
{
    /// <summary>Initializes a new instance of the <see cref="LowerHeadPayload"/> class.</summary>
    public LowerHeadPayload()
        : base(1, 1, (int)Lumina.Text.Payloads.MacroCode.LowerHead)
    {
    }
