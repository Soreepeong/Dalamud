...
/// <summary>A payload that force divides a dialog into multiple pages.</summary>
public sealed class KeyPayload : IMutableSePayload
{
    /// <summary>The singleton instance of <see cref="KeyPayload"/>.</summary>
    public static readonly KeyPayload Instance = new();
    ...
    public static ReadOnlySpan<byte> Bytes => "\x02\x17\x01\x03"u8;
    ...
    /// <inheritdoc/>
    public int MacroCode => (int)Lumina.Text.Payloads.MacroCode.Key;
