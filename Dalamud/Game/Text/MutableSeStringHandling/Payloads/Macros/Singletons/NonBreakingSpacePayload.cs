...
/// <summary>A payload that inserts a non-breaking space.</summary>
public sealed class NonBreakingSpacePayload : IMutableSePayload
{
    /// <summary>The singleton instance of <see cref="NonBreakingSpacePayload"/>.</summary>
    public static readonly NonBreakingSpacePayload Instance = new();

    private NonBreakingSpacePayload()
    {
    }

    /// <summary>Gets the immutable bytes for representing this payload.</summary>
    public static ReadOnlySpan<byte> Bytes => "\x02\x1D\x01\x03"u8;
    ...
    /// <inheritdoc/>
    public int MacroCode => (int)Lumina.Text.Payloads.MacroCode.NonBreakingSpace;
