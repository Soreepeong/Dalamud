...
/// <summary>A payload that inserts a newline.</summary>
public sealed class NewLinePayload : IMutableSePayload
{
    /// <summary>The singleton instance of <see cref="NewLinePayload"/>.</summary>
    public static readonly NewLinePayload Instance = new();

    private NewLinePayload()
    {
    }

    /// <summary>Gets the immutable bytes for representing this payload.</summary>
    public static ReadOnlySpan<byte> Bytes => "\x02\x10\x01\x03"u8;
    ...
    /// <inheritdoc/>
    public int MacroCode => (int)Lumina.Text.Payloads.MacroCode.NewLine;
