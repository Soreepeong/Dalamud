...
/// <summary>Tests a word to determine which josa to append.</summary>
public sealed class JosaPayload : FixedFormPayload
{
    /// <summary>Initializes a new instance of the <see cref="JosaPayload"/> class.</summary>
    public JosaPayload()
        : base(3, 3, (int)Lumina.Text.Payloads.MacroCode.Josa)
    {
    }
    ...
    public override void EvaluateToSeStringBuilder(ISeStringEvaluationContext context, SeStringBuilder ssb)
    {
        ...
        for (var len = 4096; len < 0x10000000; len *= 2)
        {
            ...
            var endsWithJongsung = (rune.Value - 0xAC00) % 28 != 0;
