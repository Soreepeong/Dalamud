...
internal sealed unsafe partial class Win32InputHandler : IImGuiInputHandler
{
    ...
    //         return;
    //     IntPtr focusedHwnd = Win32.GetForegroundWindow();
    ...
    //     IntPtr hovered_hwnd = Win32.WindowFromPoint(mouseScreenPos);
    ...
    //     result = (int) Win32.DefWindowProc(hWnd, WM.WM_IME_NOTIFY, (IntPtr) wParam, (IntPtr) lParam);
    ...
    private void ReleaseUnmanagedResources()
    {
        ...
        if (this.platformNamePtr != IntPtr.Zero)
